...
class ParetoWalker:
    ...
    def update_pareto_state(
        ...
        updated_front, updated_last_update = ParetoWalker._update_pareto_front_cache(
            preference, opponent_preference, pareto_front, last_pareto_update, update_frequency
        )
    ...
    def _update_pareto_front_cache(preference: nenv.Preference,
                                  ...
                                  update_frequency: int) -> tuple:
        if cached_pareto_front is None or last_pareto_update >= update_frequency:
    ...
    def _get_pareto_point(t: float, pareto_front: List[nenv.BidPoint],
        ...
        time_progress = (t - main_strategy_starting_t) / (target_time - main_strategy_starting_t)
