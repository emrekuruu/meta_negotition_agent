...
class TournamentSummaryLogger(AbstractLogger):
    ...
    def on_tournament_end(self, tournament_logs: ExcelLog, agent_names: List[str], domain_names: List[str],
        ...
        summary = pd.DataFrame(
            columns=["AgentName", "Avg.Utility", "Median.Utility", "Std.Utility", "Avg.OpponentUtility", "Median.OpponentUtility", "Std.OpponentUtility",
                     "Avg.AcceptanceTime", "Std.AcceptanceTime",
                     "Avg.Round", "Std.Round", "Avg.ProductScore", "Median.ProductScore", "Std.ProductScore", "Avg.SocialWelfare",
                     "Median.SocialWelfare", "Std.SocialWelfare", "Avg.NashDistance", "Median.NashDistance", "Std.NashDistance", "Avg.KalaiDistance",
                     "Median.KalaiDistance", "Std.KalaiDistance", "AcceptanceRate", "Count", "Acceptance", "Failed", "Error", "TimedOut",
                     "SelfError", "SelfTimedOut"])

        summary_acceptance = pd.DataFrame(columns=["AgentName",
                                                   "Avg.Utility", "Median.Utility", "Std.Utility", "Avg.OpponentUtility",
                                                   "Median.OpponentUtility", "Std.OpponentUtility",
                                                   "Avg.Round", "Std.Round", "Avg.ProductScore", "Median.ProductScore", "Std.ProductScore",
                                                   "Avg.SocialWelfare", "Median.SocialWelfare",
                                                   "Std.SocialWelfare", "Avg.NashDistance", "Median.NashDistance", "Std.NashDistance",
                                                   "Avg.KalaiDistance", "Median.KalaiDistance",
        ...
        summary_without_error = pd.DataFrame(
            columns=["AgentName", "Avg.Utility", "Median.Utility", "Std.Utility", "Avg.OpponentUtility", "Median.OpponentUtility", "Std.OpponentUtility",
                     ...
                     "Avg.Round", "Std.Round", "Avg.ProductScore", "Median.ProductScore", "Std.ProductScore", "Avg.SocialWelfare",
                     "Median.SocialWelfare", "Std.SocialWelfare", "Avg.NashDistance", "Median.NashDistance", "Std.NashDistance", "Avg.KalaiDistance",
                     "Median.KalaiDistance", "Std.KalaiDistance", "AcceptanceRate", "Count", "Acceptance", "Failed"]
        )
